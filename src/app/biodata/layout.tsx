...
export const metadata: Metadata = pageMeta({
  ...
  description:
    "Free sarkari biodata / resume maker with photo upload, education, skills packs and print-ready PDF. Private browser tool for SSC, Bank, Railway, Police forms — SizeToKB.in",
  path: "/biodata/",
  keywords: [
    "biodata maker",
